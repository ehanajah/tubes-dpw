              ...
              <div class="sticky-top px-3 pb-3 categories">
                <ul class="list-group rounded-0">
                  ...
                  <li class="list-group-item border-0">
                    ...
                    <label class="form-check-label" for="firstCheckbox">T-Shirt</label>
                  </li>
                  <li class="list-group-item border-0">
                    <input class="form-check-input me-1" type="checkbox" value="" id="secondCheckbox">
                    <label class="form-check-label" for="secondCheckbox">Shirt</label>
                  </li>
                  <li class="list-group-item border-0">
                    <input class="form-check-input me-1" type="checkbox" value="" id="thirdCheckbox">
                    <label class="form-check-label" for="thirdCheckbox">Pants</label>
                  </li>
                  <li class="list-group-item border-0">
                    <input class="form-check-input me-1" type="checkbox" value="" id="thirdCheckbox">
                    <label class="form-check-label" for="thirdCheckbox">Outer</label>
                  </li>
                  <li class="list-group-item border-0">
                    <input class="form-check-input me-1" type="checkbox" value="" id="thirdCheckbox">
                    <label class="form-check-label" for="thirdCheckbox">Accessories</label>
                  </li>
                </ul>
                
                <div class="list-group rounded-0">
                  <strong class="mt-3">Sort by</strong>
                  <hr class="mt-2">
                  <div class="btn-group-vertical mt-2 mb-4 w-100 text-start" role="group" aria-label="Vertical button group">
                    <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" checked>
                    <label class="list-group-item text-start btn btn-outline-dark rounded-0 border-0" for="btnradio1">Newest</label>

                    <input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off">
                    <label class="list-group-item text-start btn btn-outline-dark rounded-0 border-0" for="btnradio4">Price-High to Low</label>

                    <input type="radio" class="btn-check" name="btnradio" id="btnradio5" autocomplete="off">
                    <label class="list-group-item text-start btn btn-outline-dark rounded-0 border-0" for="btnradio5">Price-Low to High</label>
                  </div>
                </div>
                <hr>
                <div class="text-center mt-3">
                  <a class="link-dark text-center" href="#">back to top</a>
                </div>
              </div>
            </div>
            <div class="col-10">
